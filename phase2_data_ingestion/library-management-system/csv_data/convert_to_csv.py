...
"Libraries.csv" : [
    ["library_id", "library_name", "campus_location", "contact_email", "phone_number"],
...
"Categories.csv" : [
    ["category_id", "category", "descriptions"],
...
"Members.csv" : [
    ["member_id", "first_name", "last_name", "email", "phone_number", "member_type", "registration_date"],
...
"Borrowing.csv" : [
    ...
    [9, 9, 9, "2025-07-11", "2025-07-25", None, None],
    [10, 10, 10, "2025-07-01", "2025-07-15", "2025-07-16", 1.00],
    [11, 11, 11, "2025-07-03", "2025-07-17", None, None],
